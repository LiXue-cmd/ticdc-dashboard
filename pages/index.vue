...
<template>
  <div class="w-full flex flex-col gap-4">
    <div class="flex flex-wrap items-center justify-between gap-2">
      <h2 class="text-2xl font-bold tracking-tight">首页</h2>
    ...
    <main class="flex flex-1 flex-col gap-4 md:gap-8">
      <div class="grid gap-4 lg:grid-cols-3 md:grid-cols-2 md:gap-8">
        <Card>
          ...
          >
            <CardTitle class="text-sm font-medium"> 应用数量 </CardTitle>
        ...
        <Card>
          <CardHeader
            class="flex flex-row items-center justify-between pb-2 space-y-0"
          >
            <CardTitle class="text-sm font-medium"> 主密钥数量 </CardTitle>
        ...
        <Card>
          <CardHeader
            class="flex flex-row items-center justify-between pb-2 space-y-0"
          >
            <CardTitle class="text-sm font-medium"> 数据密钥数量 </CardTitle>
